...
mod tests {
    ...
    fn ticketswitcher_switching_test() {
        // SKIP #[expect(deprecated)] - ISSUE WITH RUST NIGHTLY: nightly-2024-05-01
        // NOTE: THIS #[expect(deprecated)] IS ALSO VERIFIED IN: rustls/src/crypto/aws_lc_rs/ticketer.rs
        // #[expect(deprecated)]
